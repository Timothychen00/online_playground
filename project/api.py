...
class GameAPI(Resource):
    ...
    parser.add_argument('game_name',type=str,location=['values'],action='append')
    parser.add_argument('author',type=str,location=['values'],action='append')
    parser.add_argument('description',type=str,location=['values'],action='append')
    parser.add_argument('users_number',type=str,location=['values'],action='append')
    parser.add_argument('sync_mode',type=str,location=['values'],action='append')
    parser.add_argument('sync_variavles',type=str,location=['values'],action='append')
    parser.add_argument('code_file', type=werkzeug.datastructures.FileStorage, location='files')
